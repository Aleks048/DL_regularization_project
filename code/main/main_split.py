...
generate_dataset.generate_dataset(N = 5000, sigma=0.5, datapath = "..\\SplitDataSet\\train")
generate_dataset.generate_dataset(N = 5000, sigma=1, datapath = "..\\SplitDataSet\\test")
#param param param
...
training_generator,test_generator = getSplitDataGenerators.getSplitDataGenerators((img_x,img_y),batch,numClasses,numOfChannels,False,"../DataSet")
